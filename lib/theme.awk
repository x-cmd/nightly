BEGIN {
    ...
    TH_TABLE_SELECTED_ROW_COL           =       UI_TEXT_DIM
    ...
    # Section: catsel
    TH_CATSEL_INFO                     =       UI_FG_YELLOW
    TH_CATSEL_HEADER                   =       UI_TEXT_UNDERLINE
    TH_CATSEL_UNDIRECTORY              =       UI_TEXT_DIM
    TH_CATSEL_ITEM_FOCUSED_SELECT      =       UI_TEXT_BOLD UI_FG_GREEN UI_TEXT_REV
    TH_CATSEL_ITEM_FOCUSED_UNSELECT    =       UI_TEXT_BOLD UI_TEXT_REV UI_FG_BLUE
    TH_CATSEL_ITEM_UNFOCUSED_SELECT    =       UI_FG_GREEN
    TH_CATSEL_ITEM_UNFOCUSED_UNSELECT  =       ""
    # EndSection
