...
# Notice: Not Applied to our components yet.
...
function u8wc( ch,      _ord ) {
    ...
    if ( 0 == U8WC_ESC_MODE ) {
        ...
        _wchar_buffer =ch
        _utf8_l = ord_leading1( _ord )
        if ( 0 == _utf8_l ) {
            U8WC_NAME   = ""
            # U8WC_TYPE =U8WC_TYPE_ASCII
            U8WC_VALUE  =  ch
            U8WC_LEN    = 1
            u8wc_handle_ascii_name_type( ch, _ord )
            return true
        } else {
            U8WC_LEN    =_utf8_l
            _utf8_l -= 1
...
function u8wc_handle_033_name( ch ) {
    ...
    else if (ch == "C")         U8WC_NAME  = U8WC_NAME_LEFT
    else if (ch == "D")         U8WC_NAME  = U8WC_NAME_RIGHT
    else                        U8WC_NAME  = ""
}
...
BEGIN{
    ...
    U8WC_NAME_ASCII_MAP[ 2 ]       =    U8WC_NAME_START_OF_TEXT        =    "STX"       #   Ctrl-B                Ctrl-B
    ...
    U8WC_NAME_ASCII_MAP[ 7 ]       =    U8WC_NAME_BELL                 =    "BEL"       #   Crtl-G                Crtl-G
    U8WC_NAME_ASCII_MAP[ 8 ]       =    U8WC_NAME_BACKSPACE            =    "BS"        #   Ctrl-H                Ctrl-H
    U8WC_NAME_ASCII_MAP[ 9 ]       =    U8WC_NAME_HORIZONTAL_TAB       =    "HT"
    U8WC_NAME_ASCII_MAP[ 10 ]      =    U8WC_NAME_NEW_LINE             =    "LF"
    U8WC_NAME_ASCII_MAP[ 11 ]      =    U8WC_NAME_VERTICAL_TAB         =    "VT"        #   Ctrl-K
    U8WC_NAME_ASCII_MAP[ 12 ]      =    U8WC_NAME_NEW_PAGE             =    "FF"        #   Crtl-L
    U8WC_NAME_ASCII_MAP[ 13 ]      =    U8WC_NAME_CARRIAGE_RETURN      =    "CR"        #   Crtl-J/M
    U8WC_NAME_ASCII_MAP[ 14 ]      =    U8WC_NAME_SHIFT_OUT            =    "SO"        #   Ctrl-N                Ctrl-N
    U8WC_NAME_ASCII_MAP[ 15 ]      =    U8WC_NAME_SHIFT_IN             =    "SI"        #   Ctrl-O
    U8WC_NAME_ASCII_MAP[ 16 ]      =    U8WC_NAME_DATA_LINK_ESCAPE     =    "DLE"       #   Ctrl-P
    U8WC_NAME_ASCII_MAP[ 17 ]      =    U8WC_NAME_DEVICE_CONTROL_1     =    "DC1"
    U8WC_NAME_ASCII_MAP[ 18 ]      =    U8WC_NAME_DEVICE_CONTROL_2     =    "DC2"       #   Ctrl-R
    U8WC_NAME_ASCII_MAP[ 19 ]      =    U8WC_NAME_DEVICE_CONTROL_3     =    "DC3"
    U8WC_NAME_ASCII_MAP[ 20 ]      =    U8WC_NAME_DEVICE_CONTROL_4     =    "DC4"       #   Ctrl-T                Ctrl-T
    U8WC_NAME_ASCII_MAP[ 21 ]      =    U8WC_NAME_NEGATIVE_ACKNOWLEDGE =    "NAK"       #   Ctrl-U                Ctrl-u
    U8WC_NAME_ASCII_MAP[ 22 ]      =    U8WC_NAME_SYNCHRONOUS_IDLE     =    "SYN"       #   Ctrl-V
    U8WC_NAME_ASCII_MAP[ 23 ]      =    U8WC_NAME_END_OF_TRANS_BLOCK   =    "ETB"       #   Ctrl-W                Ctrl-w
    U8WC_NAME_ASCII_MAP[ 24 ]      =    U8WC_NAME_CANCEL               =    "CAN"       #   Ctrl-X
    U8WC_NAME_ASCII_MAP[ 25 ]      =    U8WC_NAME_END_OF_MEDIUM        =    "EM"        #   Ctrl-Y
    U8WC_NAME_ASCII_MAP[ 26 ]      =    U8WC_NAME_SUBSTITUTE           =    "SUB"
    U8WC_NAME_ASCII_MAP[ 27 ]      =    U8WC_NAME_END_OF_ESCAPE        =    "ESC"
    U8WC_NAME_ASCII_MAP[ 29 ]      =    U8WC_NAME_GROUP_SEPARATOR      =    "GS"        #   Ctrl-}                Ctrl-}
    U8WC_NAME_ASCII_MAP[ 30 ]      =    U8WC_NAME_RECORD_SEPARATOR     =    "RS"        #   Ctrl-^
    U8WC_NAME_ASCII_MAP[ 31 ]      =    U8WC_NAME_UNIT_SEPARATOR       =    "US"        #   Ctrl-?                Ctrl-?
